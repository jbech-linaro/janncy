...
def compile_onnx() -> None:
    cmd(f"protoc -I={onnx_path}/onnx/ --cpp_out={onnx_path}/onnx {onnx_path}/onnx/onnx.proto")
    cmd(f"protoc -I={onnx_path} -I={onnx_path}/onnx/ --cpp_out={onnx_path}/onnx "
...
onnx_parser_cpps = [
        ...
        f"{onnx_path}/onnx/defs/shape_inference.cc", ] + Glob("src/*.cc")
#logging.error(onnx_parser_cpps)
